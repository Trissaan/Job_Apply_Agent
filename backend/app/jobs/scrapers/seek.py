...
async def scrape_seek_jobs(job_title: str, location: str) -> list[dict]:
    ...
    try:
        async with async_playwright() as p:
            ...
            # Try to dismiss cookie banner if it shows
            try:
            ...
            for idx, href in enumerate(job_hrefs):
                try:
                    ...
                    jd = await page.locator('div[data-automation="jobAdDetails"]').text_content() or "N/A"
                    ...
                    try:
                        ...
                        apply_button = job_url  # Fallback if apply button isn't detected
                    ...
                    await page.wait_for_selector('a[data-automation="jobTitle"]', timeout=15000)
